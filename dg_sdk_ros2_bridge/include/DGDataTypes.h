...
/// @brief Enumerated constants for setting gripper grasp options
...
/// @brief Enumerated constant for identify attached sensor type
...
///	recipeGainNumber			4							Recipe Gain Number
