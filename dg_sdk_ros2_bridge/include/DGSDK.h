...
#include "DGDataTypes.h"
	...
	*********************************************************************************************/
	/// @ brief Sets to establish communication with the gripper. This function should be the highest priority, and if it is not performed, all other functions cannot be performed.
	/// @ returns
	/// 	#Value																							#Description
	...
	*********************************************************************************************/
	...
	/// @ brief Sets the gripper IP and Port
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	*********************************************************************************************/
	...
	/// @ brief Sets the gripper GPIO output
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	/// @ brief Sets the torque limit mode for the gripper.
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	/// @ brief Sets the recipe to start upon gripper booting.
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	///		DG_RESULT_SYSTEM_SETTING_NOT_PERFORMED										No system setup
	///		DG_RESULT_DIAGNOSING_SYSTEM														Running diagnostic mode
	///		DG_RESULT_NOT_SUPPORTED_CONTROL_MODE_DEVELOPER						Not support DEVELOPER mode
	...
	*********************************************************************************************/
	/// @ brief Sets the grasp algorithm based on force control. 
	///				six basic grasp modes: three-legged, two-legged, parallel, and enveloping, and you can utilize grasp options, position control modes, and more to perform grasp actions in different ways.
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	/// @ brief Sets the I-gain value and error integral maximum for a single finger.
	/// @ param
	///		#Data Types									#Variables									#Description
	///		float*												gainI											Enter the I gain
	///		float*												iLimit											Setting the Error Integral Maximum
	...
	/// @ brief Sets the I-gain value and error integral maximum for base joints of DG-4F-M.
	/// @ param
	///		#Data Types									#Variables									#Description
	///		float*												gainI											Enter the I gain
	///		float*												iLimit											Setting the Error Integral Maximum
	...
	/// @ brief Sets the maximum values for the P, I, and D gains and error integrals for one joint.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float												gainP											Enter P Gain
	...
	/// @ brief Sets the maximum values for P, I, D gain and error integration for a single finger.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												gainP											Enter P Gain
	///		float*												gainD											Enter the D gain
	...
	/// @ brief Sets the maximum values for P, I, D gain and error integration for base joints of DG-4F-M.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												gainP											Enter P Gain
	///		float*												gainD											Enter the D gain
	...
	/// @ brief Sets the maximum values for the P, I, and D gains and error integrals for all joints
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												gainP											Enter P Gain
	///		float*												gainD											Enter the D gain
	...
	/// @ brief Sets the P, I, D gain and error integral max values for all joints in bulk.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float												gainP											Enter P Gain
	///		float												gainD											Enter the D gain
	...
	/// @ brief Sets the time to move the position of a single finger.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												motionTime									Set the time to move the location (in ms)
	...
	/// @ brief Sets the time to move the position of base joints of DG4F.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												motionTime									Set the time to move the location (in ms)
	///		int													fingerNumber								Enter the joint number
	...
	/// @ brief Sets the position travel time for every joint individually.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												motionTime									Set the time to move the location (in ms)
	/// @ returns
	...
	/// @ brief Sets the position travel time for all joints in bulk.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int													motionTime									Set the time to move the location (in ms)
	/// @ returns
	...
	/// @ brief Sets the position control mode for a single finger joints.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												positionMode								Enable position control mode
	///		int													fingerNumber								Enter the finger number
	...
	/// @ brief Sets the position control mode for base joints of DG-4F-M.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												positionMode								Enable position control mode
	///		int													fingerNumber								Enter the finger number
	...
	/// @ brief Sets the position control mode for single finger joints
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int*												positionMode								Enable position control mode
	/// @ returns
	...
	/// @ brief Sets the gripper to current-based position control mode
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	/// @ brief Sets the target current value for one joint.
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	/// @ brief Sets the target current value for a single finger joint.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												targetCurrent								Enter a target current value (mA)
	///		int													fingerNumber								Enter the finger number
	...
	/// @ brief Sets the target current value for base joints of DG-4F-M.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												targetCurrent								Enter a target current value (mA)
	///		int													fingerNumber								Enter the finger number
	...
	///		DG_RESULT_DIAGNOSING_SYSTEM														Running diagnostic mode
	///		DG_RESULT_OVERFLOW_CURRENT_LIMIT												Maximum current value exceeded
	DGSDK DG_RESULT SetJointCurrentGainI(float currentGainI, float currentILimit, int jointNumber);
	DGSDK DG_RESULT SetJointCurrentGainIFinger(float* currentGainI, float* currentILimit, int fingerNumber);
	DGSDK DG_RESULT SetJointCurrentGainIAll(float* currentGainI, float* currentILimit);
	DGSDK DG_RESULT SetJointCurrentGainIBase(float* currentGainI, float* currentILimit);

	DGSDK DG_RESULT SetJointCurrentGainP(float currentGainP, int jointNumber);
	DGSDK DG_RESULT SetJointCurrentGainPFinger(float* currentGainP, int fingerNumber);
	DGSDK DG_RESULT SetJointCurrentGainPAll(float* currentGainP);
	DGSDK DG_RESULT SetJointCurrentGainPBase(float* currentGainP);
	...
	/// @ brief Saves the currently set gripper joint's target position information and action time to the entered number of pose recipes
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int													recipeNumber								Recipe Pose Number
	/// @ returns
	...
	/// @ brief Reads and sets the gain recipe data for the entered number
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    int													recipeNumber								Recipe gain number
	/// @ returns
	...
	****    Motion Functions
	*********************************************************************************************/
	/// @ brief Sets the gripper to manual teaching mode. Manual teaching mode allows a human to set the gripper pose and teach all joints directly.
	/// @ param
	///		#Data Types									#Variables									#Description
	...
	*********************************************************************************************/
	...
	/// @ brief Sets gain values for the X, Y, Z, RX, RY, and RZ axes per finger.
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												gainP											Enter P Gain
	///		int													fingerNumber								Enter the finger number
	...
	/// @ brief Sets the P-gain of the entire finger for gripper TCP positioning
	/// @ param
	///		#Data Types									#Variables									#Description
	///	    float*												gainP											Enter P Gain
	/// @ returns
	...
	/// @ brief Sets the D-gain for one finger for gripper TCP positioning control.
	/// @ param
	///		#Data Types									#Variables									#Description
	///		float*												gainD											Enter the D gain
	///		int													fingerNumber								Enter the finger number
	...
	/// @ brief Sets the maximum values for P, I, D gain and error integration for one finger for gripper TCP position control
	/// @ param
	///		#Data Types									#Variables									#Description
	///		float*												gainP											Enter P Gain
	///		float*												gainD											Enter the D gain
	...
	/// @ brief Sets the maximum values of the P, I, D gains and error integrals for all fingers for gripper TCP position control
	/// @ param
	///		#Data Types									#Variables									#Description
	///		float*												gainP											Enter P Gain
	///		float*												gainD											Enter the D gain
	...
	/// @ brief Sets the same target coordinate arrival time for all fingers when controlling gripper TCP positioning
	/// @ param
	///		#Data Types									#Variables									#Description
	///		int													motionTime									Set the time to move the location(in ms)
	/// @ returns
	...
	/// @ brief Sets the P, I, D gains and error integral maximums for inhand manipulation Motion. 
	...
	/// @ brief Sets current position to Encoder zero
	///  @return 
	///     #Value																							#Description
	///     DG_RESULT_NONE																			 Normal
	/// 
